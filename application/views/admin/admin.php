...
<head>
	...
	<link rel="stylesheet" href="assets/css/admin/resetcss.css">
...
<body onload="checkPage()">
	...
	<form action="<?php echo base_url(''); ?>admin/login" method="post" enctype="multipart/form-data">
		...
		<div class="inputGroup inputGroup1">
			...
			<input type="text" id="loginEmail" maxlength="254" name="username" require=""/>
			<p class="helper helper1">Username</p>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="loginPassword" id="loginPasswordLabel">Password</label>
			<input type="password" id="loginPassword" name="password" require=""/>
